"""Alembic env.py — async-режим поверх SQLAlchemy 2.x + asyncpg.

URL БД берётся из ``rir2localdb.config.Settings`` (env / .env), а не из
``alembic.ini`` — чтобы единый источник конфигурации для всего проекта.
"""
